...
function showToast(text,type) {
	if(!$('#weui-toast').length) {
		$('.container').append('<div id="weui-toast"><div class="weui-mask_transparent"></div><div class="weui-toast"><i class="weui-icon-'+type+'" weui-icon_toast"></i><p class="weui-toast__content" id="weui-toast-msg" style="margin-top:10px;"></p></div></div>');
	}else {
		$('#weui-toast').remove();
